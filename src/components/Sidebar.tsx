...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <aside className="w-64 bg-white text-stone-700 flex flex-col border-r border-orange-200 h-screen select-none shrink-0">
      {/* Brand Signature */}
        ...
        {menuItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center justify-between px-3.5 py-3 rounded-xl transition-all duration-200 group relative ${
                isActive
